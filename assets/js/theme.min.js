...
jQuery(document).ready(function(){function e(){jQuery("pre code").each(function(e){"undefined"!=typeof jQuery(this).attr("data-language")&&jQuery(this).attr("data-language")!==!1||jQuery(this).attr("data-language","javascript")}),config.highlightcode===!0&&Rainbow.color()}function t(){config.layout_right_sidebar===!0&&(jQuery(".content").addClass("leftside"),jQuery(".alternate").addClass("rightside"))}function n(){jQuery(".post").fitVids()}function i(){jQuery(".inlinemenu > .menu li:nth-of-type(1) a").before('<i class="fal fa-outdent"></i>'),jQuery(".inlinemenu > .menu li:nth-of-type(2) a").before('<i class="fal fa-portrait"></i>'),jQuery(".inlinemenu > .menu li:nth-of-type(3) a").before('<i class="fal fa-wrench"></i>'),jQuery(".inlinemenu > .menu li:nth-of-type(4) a").before('<i class="fal fa-rocket"></i>')}function a(){0===jQuery(".pagination a").length&&jQuery(".pagination").hide()}function o(){config.show_ecko_disclaimer===!1&&jQuery(".copyright .ecko").hide()}function s(){jQuery(".comments .graybar").show(),(0!==jQuery(".comments").length&&""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname||config.google_comments===!0)&&jQuery(".comments .graybar").show(),jQuery(".comments .graybar").click(function(){r()}),config.autoload_comments===!0&&r()}function r(){if(0!==jQuery(".comments").length&&""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname&&""!==config.disqus_shortname){var e=config.disqus_shortname;!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="//"+e+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(t)}()}jQuery(".disqus_thread").show(),jQuery(".comments .graybar").html('<i class="fa fa-comments"></i>Comments')}function c(){""!==config.analytics_id&&null!==config.analytics_id&&void 0!==config.analytics_id&&(!function(e,t,n,i,a,o,s){e.GoogleAnalyticsObject=a,e[a]=e[a]||function(){(e[a].q=e[a].q||[]).push(arguments)},e[a].l=1*new Date,o=t.createElement(n),s=t.getElementsByTagName(n)[0],o.async=1,o.src=i,s.parentNode.insertBefore(o,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create",config.analytics_id,"auto"),ga("send","pageview"))}function u(){jQuery(".shorttabs").each(function(){jQuery(".shorttabscontent",this).hide(),jQuery(".shorttabscontent",this).first().show(),jQuery(".shorttabsheader",this).first().addClass("active")})}var l=$(".content")[0].textContent,d=l.replace(/[^\w ]/g,"").split(/\s+/).length,y=Math.floor(d/250)+1,g=y+" min";$("article .reading-time").html(g),function(){a(),e(),o(),n(),s(),c(),u(),t(),i()}(),jQuery(".backtotop").click(function(){return jQuery("html, body").animate({scrollTop:0},"slow"),!1}),jQuery(".inlinemenu > .graybar").click(function(){jQuery(".inlinemenu > .menu").toggle()}),jQuery(".shorttoggle .toggleheader").click(function(){jQuery(this).siblings(".togglecontent").toggle()}),jQuery(".shorttabsheader").click(function(){jQuery(".shorttabscontent",jQuery(this).parent()).hide(),jQuery(".shorttabsheader.active",jQuery(this).parent()).removeClass("active"),jQuery(this).addClass("active"),jQuery(".shorttabscontent[data-id='"+jQuery(this).attr("data-id")+"']").show()})});